...
def show_shopping_cart():
    ...
    return render_template("cart.html", melon_list=melon_objs, total=total_cost)
...
def add_to_cart(melon_id):
    ...
    # Check if "cart" exists in the session, and create one (an empty
    ...
    flash(f"{melon_name} has been added to the cart")
